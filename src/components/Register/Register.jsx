...
const Register = () => {
    ...
    const regSubmit = () => {
        axios
            ...
            .catch((err) => {
                if (err.request)
                    toast.error("Server is down right now! Check back later!", {
                        position: toast.POSITION.BOTTOM_CENTER,
                    });
                else if (err.response.data.msg === "Already registered email")
                    toast.error("Already registered user!", {
                        position: toast.POSITION.BOTTOM_CENTER,
                    });
                else if (err.response.data.msg === "Password too short")
                    toast.error(
                ...
                else if (err.response.data.msg === "Fill out all inputs")
